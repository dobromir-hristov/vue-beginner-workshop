export default {
  ...
  targaryen: {
    name: 'Targaryen',
    sigil:
      'https://vignette.wikia.nocookie.net/gameofthrones/images/4/43/House-Targaryen-Main-Shield.PNG/revision/latest',
    members: [
  ...
  tyrell: {
    name: 'Tyrell',
    sigil:
      'https://vignette.wikia.nocookie.net/gameofthrones/images/c/cf/House-Tyrell-Main-Shield.PNG/revision/latest',
    members: [
  ...
  baratheon: {
    name: 'Baratheon',
    sigil:
      'https://vignette.wikia.nocookie.net/gameofthrones/images/0/00/House-Baratheon-Main-Shield.PNG/revision/latest',
    members: [
  ...
  martell: {
    name: 'Martell',
    sigil:
      'https://vignette.wikia.nocookie.net/gameofthrones/images/7/7e/House-Martell-Main-Shield.PNG/revision/latest',
    members: [
